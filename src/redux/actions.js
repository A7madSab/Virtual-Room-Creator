...
export const createProject = project => async dispatch => {
    ...
    try {
        const createdProject = await firebase.firestore().collection("projects").add({ ...project, autherFirstName: "Ahmad", autherLastName: "Sabry", autherId: 5642, createdAt: new Date() })
